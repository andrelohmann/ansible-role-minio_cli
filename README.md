...
![Last test](https://github.com/andrelohmann/ansible-role-minio_cli/actions/workflows/test.yml/badge.svg)

## Content

Install minio cli mc from binary packages.
...
There are no role variables to be set.

### Example Playbook

    - hosts: minio
      roles:
      - { role: andrelohmann.minio_cli }
